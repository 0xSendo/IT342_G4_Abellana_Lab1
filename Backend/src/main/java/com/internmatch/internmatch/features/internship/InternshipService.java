...
public class InternshipService {
    ...
    private InternshipResponse mapToResponseWithApplicants(Internship internship, boolean includeApplicants) {
        ...
        return InternshipResponse.builder()
                ...
                .postedByUserId(internship.getPostedBy().getId())
                .postedByEmail(includeApplicants ? internship.getPostedBy().getEmail() : null)
                .postedByName(includeApplicants ? internship.getPostedBy().getName() : null)
